...
const TodoSchema = new mongoose.Schema({ //defines the todo schema, the format for all todo items
  ...
  completed: { //Declares the variable for that item
    type: Boolean, //Declares that it is a boolean
    required: true, //Requires this for the submission
  },
  userId: { //Declares the variable for that item
    type: String, //Declares that it is a string
